...
sub add_product {
  ...
  $self->add_valid_product($hParms{product}) if $add_base_prod;
...
package Product1 {
  use base 'Products'; 
  sub new { my $class = shift; $class->SUPER::build( product => __PACKAGE__, @_)}
}
...
package Product2 {
  use base 'Products';
  sub new { my $class = shift; $class->SUPER::new( product => __PACKAGE__, @_)}
}
